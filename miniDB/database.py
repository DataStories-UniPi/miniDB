...
class Database:
    ...
    def create_table(self, name, column_names, column_types, not_null_columns, unique_columns, primary_key=None, load=None):
        ...
        Args:
            ...
            not_null_columns: Column names with not null values
            unique_columnsQ Column names with unique values
            primary_key: string. The primary key (if it exists).
            load: boolean. Defines table object parameters as the name of the table and the column names.
        '''
        # print('here -> ', column_names.split(','))
        self.tables.update({name: Table(name=name, column_names=column_names.split(','), column_types=column_types.split(','), not_null_columns=not_null_columns.split(',') ,unique_columns=unique_columns.split(',') ,  primary_key=primary_key, load=load)})
