...
db.create_table('instructor', ['ID', 'ins_name', 'dept_name','salary'], [str,str,str,int], primary_key='ID')
...
db.create_table('student', ['ID', 'st_name', 'dept_name', 'tot_cred'], [str,str,str,int], primary_key='ID')
