...
class Database:
    ...
    def selectBetween(self,table_name,col_name,value1,value2):
        # print(table_name)
        self.load_database()
        if isinstance(table_name,Table):
            return table_name._select_whereBetween(col_name, value1, value2)
    def selectNot(self,table_name,col_name,value1):
        # print(table_name)
        self.load_database()
        if isinstance(table_name,Table):
            return table_name._select_whereNot(col_name, value1)
    def selectAnd(self,table_name,col_name,value1,col_name2,value2):
        # print(table_name)
        self.load_database()
        if isinstance(table_name,Table):
            return table_name._select_whereAnd(col_name, value1,col_name2,value2)
    def selectOr(self,table_name,col_name,value1,value2):
        # print(table_name)
        self.load_database()
        if isinstance(table_name,Table):
            return table_name._select_whereOr(col_name, value1, value2)
