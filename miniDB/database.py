...
class Database:
    ...
    def create_table(self, name, column_names, column_types, column_constraints, primary_key=None, load=None):
        ...
        '''
        # If there are no column constraints create the tables from here
        ...
        # If there are column constraints create the tables from here
        else:
            self.tables.update({name: Table(name=name, column_names=column_names.split(','),
                                            column_types=column_types.split(','),
                                            column_constraints=column_constraints.split(','),
                                            primary_key=primary_key,
                                            load=load)})
            # self._name = Table(name=name, column_names=column_names, column_types=column_types, load=load)
            # check that new dynamic var doesnt exist already
